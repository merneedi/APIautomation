...
from src.helpers.utilis import common_headers_json,common_headers_for_put_Delete_Patch
...
class TestCreateBooking(object):
    ...
    def test_update_booking(self): # bookingid and token from create booking
            ...
            put_url = APIConstants.url_create_booking() +"/1583"
    ...
    def test_delete_booking(self):
        delete_url = APIConstants.url_create_booking() + "/1583"
        response = put_requests(url=delete_url, auth=None, headers=common_headers_for_put_Delete_Patch(),
